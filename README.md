...
3. [Логика работы модели](#логика-работы-модели)
4. [Модули и их функции](#модули-и-их-функции)
...
8. [Примеры работы модели](#примеры-работы-модели)


***

## 1. ОБЩЕЕ ОПИСАНИЕ СИСТЕМЫ {\#общее-описание}
...
## 3. ЛОГИКА РАБОТЫ МОДЕЛИ {\#логика-работы}
...
## 5. ФОРМАТ ВХОДНЫХ ДАННЫХ {\#входные-данные}
...
## 6. РЕЗУЛЬТАТЫ РАБОТЫ {\#результаты}
